...
public class CRUD {
	...
	private EntityManagerFactory emf  =  Persistence.createEntityManagerFactory("PROG4691_T1_Picon_Arevalo_Jhonatan");
	...
	public void eliminar(int id) {
        ...
        if (entr != null) {
            em.remove(entr);
            System.out.println("El entrenador fue removido correctamente");
        } else {
